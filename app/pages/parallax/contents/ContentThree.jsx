...
const ContentThree = () => {
  return (
    <HoverContainer className="ml-auto w-[300px] relative p-3 mr-[7%]">
      <h1 className="font-secondary text-lg relative z-[5] pointer-events-none font-light">
        I'm a
        <motion.span
          variants={animationForHeader}
          initial="hidden"
          whileInView="visible"
          className="gold-text  px-1 text-2xl"
        >
          react
        </motion.span>
