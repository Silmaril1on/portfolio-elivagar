...
const ProjectImages = ({ item }) => {
  return (
    <div className="w-full flex flex-col space-y-2 relative group ">
      ...
      <div className="flex flex-row justify-between space-x-2 w-full h-full *:w-[32.5%] *:brightness-75 *:group-hover:brightness-100">
